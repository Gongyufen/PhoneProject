...
<body>
	...
	<jsp:param  name="name" value="${list.get(0).getC_aid()}"/>
	</jsp:include>
	<div id="shang">
					<form action="ChaGuigeServlet" method="get">
						<div id="yh"><span>规格名称：</span><input type="text" name="mc"/></div>
        ...
        <tr>
            ...
            <td>${item.c_did}</td>
            <td>    
            	<form action="SCGuigeServlet" method="get">
            <input type="hidden" name="id" value="${item.c_aid}" />
